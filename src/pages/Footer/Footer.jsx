...
export default function Footer() {
  ...
  <path d="M8.03953 4.749H5.183V13.5351H8.03953C8.03953 13.5351 8.03953 10.7691 8.03953 9.0397C8.03953 8.00167 8.38872 6.95909 9.78201 6.95909C11.3566 6.95909 11.3471 8.31752 11.3398 9.36993C11.3302 10.7456 11.3531 12.1494 11.3531 13.5351H14.2096V8.89801C14.1854 5.93707 13.4253 4.57273 10.9246 4.57273C9.43955 4.57273 8.519 5.25708 8.03953 5.87624V4.749Z" fill="#700619"/>
      ...
      <div className="footer-enddiv py-8 w-full flex justify-between px-10 md:flex-col md:gap-6 md:px-4 md:items-center">
          ...
          <p className="footer-enddiv-termscondition">User Terms & Conditions | Privacy Policy</p>
      </div>
    </footer>
  );
}
